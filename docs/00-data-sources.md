...
| 소스 | 하한 | 근거 |
|---|---|---|
| DART | **2015년** | 공식 문서 "2015년 이후부터 정보제공" |
| SEC EDGAR | **2009년 무렵** | XBRL 제출이 2009~2011 단계적 의무화. 실측: AAPL 2007-09, NVDA 2008-01, INTC 2007-12 |

⚠️ 한동안 2015 를 **전 소스 공통 하한**으로 쓰고 있었다. DART 의 한계를 미국 기업에까지
적용한 것이라, "전체" 기간을 골라도 10년만 보였다. 국가별로 나눠서
`earliestYearFor()` 가 선택된 기업 구성에 따라 하한을 정하도록 고쳤다.

여러 기업을 함께 볼 때는 **합집합**을 쓴다. 삼성전자(2015~)와 NVIDIA(2009~)를 함께 고르면
2009년부터 보여주고 삼성전자 쪽은 2014년까지 선이 끊긴다. 교집합으로 자르면
NVIDIA 의 긴 이력이 통째로 사라진다 — 비교 도구가 정보를 먼저 버릴 이유가 없다.
