...
> **`alignedYear` = (periodEnd − 6개월)이 속한 달력 연도**
>
> 연간 기간의 중간 지점이 속한 해로 배정한다는 뜻이다.

실데이터로 검증 — SEC 자체 `frame` 값과 일치한다:

| 기업 | periodEnd | −6M | alignedYear | SEC frame | 일치 |
|---|---|---|---|---|---|
| AAPL | 2025-09-27 | 2025-03 | **2025** | CY2025 | ✅ |
| AAPL | 2024-09-28 | 2024-03 | **2024** | CY2024 | ✅ |
| NVDA | 2022-01-30 | 2021-07 | **2021** | CY2021 | ✅ |
| NVDA | 2017-01-29 | 2016-07 | **2016** | CY2016 | ✅ |

즉 결산월 7~12월 → 당해 연도, 1~6월 → 직전 연도. 분기도 같은 논리로 3개월 중간점 기준.
